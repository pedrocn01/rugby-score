...
<execution_context>
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/settings-advanced.md`.
