...
<execution_context>
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/docs-update.md end-to-end.
