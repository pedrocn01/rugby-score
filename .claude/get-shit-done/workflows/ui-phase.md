...
```markdown
Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-ui-checker.md for instructions.
