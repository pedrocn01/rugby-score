...
Key references:
- @C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/src/Proyectos/rugby_app/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/src/Proyectos/rugby_app/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/src/Proyectos/rugby_app/.claude/get-shit-done/USER-PROFILE.md" "C:/src/Proyectos/rugby_app/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/src/Proyectos/rugby_app/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/src/Proyectos/rugby_app/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/src/Proyectos/rugby_app/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/src/Proyectos/rugby_app/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/src/Proyectos/rugby_app/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/src/Proyectos/rugby_app/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/src/Proyectos/rugby_app/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/src/Proyectos/rugby_app/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/src/Proyectos/rugby_app/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/src/Proyectos/rugby_app/.claude/CLAUDE.md
```
