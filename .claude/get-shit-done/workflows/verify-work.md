...
Read and follow `C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/diagnose-issues.md
