...
INSTALL_JS_GLOBAL="C:/src/Proyectos/rugby_app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/src/Proyectos/rugby_app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
