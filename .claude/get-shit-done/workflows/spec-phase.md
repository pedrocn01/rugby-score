...
```bash
INIT=$(node "C:/src/Proyectos/rugby_app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/spec.md.
