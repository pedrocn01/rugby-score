...
<required_reading>
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/ai-frameworks.md
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-eval-planner.md for instructions.
