...
```
Task(
  prompt="Read C:/src/Proyectos/rugby_app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/VALIDATION.md`
