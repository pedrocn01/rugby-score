...
<!-- For checkpoint task examples and patterns, see @C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/src/Proyectos/rugby_app/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
