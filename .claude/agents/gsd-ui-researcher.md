...
Use template from `C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/UI-SPEC.md`
