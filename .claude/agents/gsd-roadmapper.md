...
Reference full template: `C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/src/Proyectos/rugby_app/.claude/get-shit-done/templates/state.md`.
