...
<reference>
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/user-profiling.md` to load:
