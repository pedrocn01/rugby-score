...
<required_reading>
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/src/Proyectos/rugby_app/.claude
                  → checks C:/src/Proyectos/rugby_app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/src/Proyectos/rugby_app/.claude/get-shit-done
                  → writes to C:/src/Proyectos/rugby_app/.claude/get-shit-done/hooks/
...
@C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/src/Proyectos/rugby_app/.claude/get-shit-done/references/common-bug-patterns.md
