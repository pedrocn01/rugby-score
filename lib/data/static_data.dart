...
class StaticDataService {
  ...
  static final List<dynamic> _superRugbyStandings = [
    ...
    {'position':5,'team':{'name':'Crusaders'},     'games':{'played':7,'win':{'total':3},'draw':{'total':0},'lose':{'total':4}},'points':15,'description':null},
    {'position':6,'team':{'name':'Western Force'}, 'games':{'played':7,'win':{'total':3},'draw':{'total':0},'lose':{'total':4}},'points':14,'description':null},
